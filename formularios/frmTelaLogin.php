...
<head>
    ...
    <link rel='stylesheet' href='../bootstrap-4.5.2-dist/dist/css/bootstrap.min.css'>
...
<body>
    <form action='../metodos/login.php' method='POST' id='frmLogin' name='frmLogin' onsubmit='Validar(); return false;'>
            ...
            <div class='table-responsive-x border border-dark col-md-6 p-0'>
                ...
                <div class='p-3 bg-white'>
                    ...
                    <div>
                        ...
                        <button type='button' class='btn btn-primary btn btn-dark  btn-block' onclick="JavaScript:location.href='../formularios/frmTelaCadastro.php'">Cadastrar</button>
                    </div>
                </div>
