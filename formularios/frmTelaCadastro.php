...
<body>
  <form action='../metodos/insUsuario.php' method='POST' id='frmCad' name='frmCad' onsubmit='Valida(); return false;'>
    <div class='w-50 p-3'>
      <div class='table table-responsive-x bg-white border border-secondary col-md-12 p-0'>
        ...
        <div class='p-3'>
          ...
          <div>
            ...
            <button type='button' class='btn btn-primary btn btn-dark btn-block' onclick="JavaScript:location.href='../formularios/frmTelaLogin.php'">Já possuí uma conta?</button>
          </div>
        </div>
